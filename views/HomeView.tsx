    ...
    <div className="max-w-4xl mx-auto space-y-12 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-800/40 backdrop-blur-md rounded-3xl p-8 border border-slate-700 flex flex-col items-center space-y-6">
          ...
          <button onClick={() => onNavigate(ViewType.VOTE)} className="w-full py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-2xl transition-all">
            我要投票
          </button>
        </div>
      </div>
